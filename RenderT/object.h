...
public:
	...
	virtual void setTexture(int texId, TexMapType eType);
...
public:
	...
	void setTexture(int texId, TexMapType eType){};
...
///
class Sphere : public PrimaryObject
{
public:
	Sphere(	float fRadius, vect3d &pCenterPos, 
			float fReflR = 1.f, float fRefrR = 0.f, float fRefrK = 1.f, float fEmitR = 1.0);
